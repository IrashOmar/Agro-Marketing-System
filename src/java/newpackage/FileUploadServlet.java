...
public class FileUploadServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            PreparedStatement pst = con.prepareStatement("insert into trybackend (FarmName,TreeName,Price,Category,Location,Details,filename,path) values (?,?,?,?,?,?,?,?)");
            pst.setString(1, FarmName);
