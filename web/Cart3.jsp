...
<body>
  ...
  <main class="container">
    ...
    <div class="item-flex">
      ...
      -->
         <%
                    String product_id = request.getParameter("tree_id");
                  ...
                  //  Statement statement2 = null;
                   // ResultSet resultSet2 = null;
                    ...
                    String cat_id1=resultSet.getString("tree_id");
                   // String cat_id2=resultSet.getString("id");
                    statement1=connection.createStatement();  
                   String sql1 ="SELECT * FROM trybackend where tree_id="+cat_id1 ;
                  // String sql2 ="SELECT * FROM trybackend where id="+cat_id2 ;
                   //   String sql1 = "SELECT trybackend.tree_id, tree.ProductName From trybackend inner join tree on trybackend.tree_id = tree.ProductName";
          ...
          <div class="product-card">
            ...
            <div class="card">
              ...
              <div class="detail">
                ...
                <h4 class="product-name"><%=resultSet1.getString("FarmName")%></h4>
