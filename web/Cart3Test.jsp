...
<html lang="en">
    ...
    <body>
        ...
        <main class="container">
            ...
            <h1 class="heading">
                <ion-icon name="cart-outline"></ion-icon> Item Checkout
            </h1>
...
//                                    String cart_id = request.getParameter("cart_id");
                                    ...
                                    while (resultSet.next()) {
                                        String cart_id = resultSet.getString("tree_id");
                                        statement1 = connection.createStatement();
                                        String sql1 = "SELECT carttest.quantity, tree.ProductName"
                                                + ",trybackend.Price FROM carttest JOIN tree ON carttest"
                                                + ".tree_id = tree.tree_id" + " JOIN trybackend ON carttest.tree_id = trybackend.tree_id WHERE tree_id="+cart_id;
                            ...
                            <div class="card">
                                ...
                                <!--                                <div class="img-box">
                                                                    <img src="code/checkout/images/green-tomatoes.jpg" alt="Green tomatoes" width="80px" class="product-img">
                                                                </div>-->
                                ...
                                <a href='deleteCart.jsp?d='<%=resultSet1.getString("tree_id")%><button class="product-close-btn">
                                    <ion-icon name="close-outline"></ion-icon>
                                    </button></a>
                                <!--                                <div class="pricing-action">
                                                                    <a href="deleteCart.jsp?cart_id=" class="btn btn-medium"><i class="icon-bolt"></i>Delete</a>
                                                                </div>-->
                        ...
                        <!--
                                  <div class="product-card">
                                    ...
                                    <div class="card">
                                      ...
                                      <div class="img-box">
                                        <img src="code/checkout/images/cabbage.jpg" alt="Cabbage" width="80px" class="product-img">
                                      </div>
...
<!--
  - custom js link
-->
<script src="code/checkout/script3.js"></script>
