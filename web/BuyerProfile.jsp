                            ...
                            <div class="card-body">
                                <%
                                    ...
                                    try {
                                        ...
                                        String data = "select * from buyerregistration";
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="input-email" class="form-control form-control-alternative" placeholder="xxxxxx-xx-xxxx" value="<%=res.getString("ic")%>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group focused">
                                                    ...
                                                    <input id="input-address" class="form-control form-control-alternative" placeholder="Home Address" value="<%=res.getString("address")%>" type="text">
                                                </div>
                                                <div class="form-group focused">
                                                    <label class="form-control-label" for="input-address">Phone Number</label>
                                                    <input id="input-address" class="form-control form-control-alternative" placeholder="Home Address" value="<%=res.getString("phone")%>" type="text">
                                                </div>
                                            </div>
                                        </div>
                                        <!--                  <div class="row">
