...
//                        int num = Integer.parseInt(u);
                                        String data = "select * from buyerregistration where buyId='" + u + "'";
                                    ...
                                    <div class="form-group has-feedback">
                                        ...
                                        <input type="text" class="form-control" name="ic" placeholder="" value="<%=res.getString("ic")%>">
                                        <i class=" form-control-feedback"></i>
                                    </div>
                                    <div class="form-group has-feedback">
                                    ...
                                    <div class="form-group has-feedback">
                                        ...
                                        <input type="text" class="form-control" name="password" placeholder="" value="<%=res.getString("password")%>">
                                        <i class=" form-control-feedback"></i>
                                    </div>
                                    ...
                                    <input type="submit" value="Submit" id="submit" class="submit btn btn-default">
                                     <a href='deleteBuyer.jsp?d=<%=res.getString("buyId")%>' class="btn btn-danger">Delete</a><!-- comment -->
                                </form>
                                        <%
        ...
        String e = request.getParameter("ic");
        String f = request.getParameter("address");
        String g = request.getParameter("phone");


        if (a != null && b != null && c != null && d != null  && e != null && f != null && g != null){
             String query = "update buyerregistration set email='" + b + "',name='" + c + "',password='" + d + "',ic='" + e + "',address='" + f + "',phone='" + g + "' where buyId='" + a + "'";
